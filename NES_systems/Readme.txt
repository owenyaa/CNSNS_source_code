The program in this folder is to obtain the quasi periodic solution of Nonlinear energy sink (NES) system with single external excitation through the ETMRM (example 2 in the paper).
