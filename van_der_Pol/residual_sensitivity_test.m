clc;clear;close all;
global tf h N_dof N_harm N_w0 Tdata index_global
%% parameters
e=1.08;w0_2=1;a=1;f1=0.2;f2=1;w1=1;w2=0.765;
N_dof=1;N_harm=18;N_w0=2;%基频个数
w0=zeros(1,2*N_dof);
w0(1,1:N_w0)=[w1,w2];
% 其他参数
...
C0_1=0.342172594555505;S0_1=0.1;
C0_2=-0.000646804589735;S0_2=0.000571448020811;
parameter_a=zeros(N_harm,2*N_dof);
% parameter_a(1,:)=w0;
parameter_a(1:2,:)=[C0_1,S0_1;C0_2,S0_2];   % 6行2列
...
%     parameter_a(1,:)=w0;
%     parameter_a(2:4,:)=[C0_1,S0_1,C0_2,S0_2,C0_2,S0_2];   % 6行2列
%     
%     %% 参数系数矩阵，1代表求此处参数的差分
...
%     hold on
%     plot(Tdata,residual(:,N_dof*(i+N_w0)+2),'r-')
%     hold on
%     plot(Tdata,residual(:,N_dof*(i+N_w0)+3),'r-')
%     hold on
%     
%     plot(Tdata,aaaa(:,1),'k-')
%     hold on
